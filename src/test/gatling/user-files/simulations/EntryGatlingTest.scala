...
class EntryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Entry entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/entries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new entry")
            .post("/jhipstergatlingtestapplication/api/entries")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_entry_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created entry")
            .delete("/jhipstergatlingtestapplication${new_entry_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
