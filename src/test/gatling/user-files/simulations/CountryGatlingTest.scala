...
class CountryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Country entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/countries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new country")
            .post("/jhipstergatlingtestapplication/api/countries")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_country_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created country")
            .delete("/jhipstergatlingtestapplication${new_country_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
