...
class RegionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Region entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/regions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new region")
            .post("/jhipstergatlingtestapplication/api/regions")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_region_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created region")
            .delete("/jhipstergatlingtestapplication${new_region_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
