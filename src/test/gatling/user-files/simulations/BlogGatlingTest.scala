...
class BlogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Blog entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/blogs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new blog")
            .post("/jhipstergatlingtestapplication/api/blogs")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_blog_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created blog")
            .delete("/jhipstergatlingtestapplication${new_blog_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
