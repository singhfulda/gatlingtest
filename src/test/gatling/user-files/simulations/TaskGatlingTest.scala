...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/tasks")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new task")
            .post("/jhipstergatlingtestapplication/api/tasks")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_task_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created task")
            .delete("/jhipstergatlingtestapplication${new_task_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
