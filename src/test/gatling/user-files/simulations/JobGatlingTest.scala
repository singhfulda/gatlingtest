...
class JobGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstergatlingtestapplication/api/jobs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new job")
            .post("/jhipstergatlingtestapplication/api/jobs")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstergatlingtestapplication${new_job_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created job")
            .delete("/jhipstergatlingtestapplication${new_job_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
